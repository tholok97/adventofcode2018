...
# NOTES: 
#   - PART 2 could probably be sped up a whole lot by figuring out a way 
#     to call sed only once. Give it one line per removed character for example?
#   - `wc -c` outputs some leading spaces as described here: 
#      https://unix.stackexchange.com/questions/205906/extra-space-with-counted-line-number.
#      These are removed using Bash parameter expansion
